...
//g++ -o window -std=c++11 -Wall window.cpp GLShader.cpp GLShader.hpp Image.hpp Image.cpp Utils.hpp Utils.cpp Patch.hpp Patch.cpp Pixel.hpp Pyramid.hpp Pyramid.cpp -lGL -lGLEW -lglfw3 -lpthread -lXrandr -lX11 -ldl -lXi -lXxf86vm -lXinerama -lrt -lm -lXcursor -lSOIL
...
//    std::shared_ptr<Image> image2 (new Image("texture_brick_256.png"));
	std::shared_ptr<Image> image2(new Image("texture_stone.png"));
//	std::shared_ptr<Image> image(new Image(*image2.get()));
//	image->gaussBlur(5.0f)->downscale();
...
//	image->noiseFrom(image2);
	...
	image->save("texture_stone_synthesized.tga");
//	image->generateNoise();
